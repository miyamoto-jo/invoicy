    ...
    >
      ...
      <nav class="menu-items">
        ...
        <div class="menu-section">
          ...
          <router-link to="/invoices/analytics" class="menu-item" @click="closeMenu">
            <div class="menu-icon invoice-analytics-icon">📊</div>
            <span class="menu-text">請求書分析</span>
          </router-link>
        </div>
